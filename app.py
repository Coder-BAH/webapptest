...
voted_users  = st.number_input('num_voted_users:',min_value=1.0, max_value=100.0)
duration = st.number_input('duration:',min_value=10.0, max_value=500.0)
budget = st.number_input('budget:',min_value=100.0, max_value=1000.0)
movie_facebook_likes = st.number_input('movie_facebook_likes:',min_value=10.0, max_value=1000000.0)
gross = st.number_input('gross:',min_value=100.0, max_value=1000000.0)
actor_1_facebook_likes = st.number_input('actor_1_facebook_likes:',min_value=10.0, max_value=100000.0)
cast_crew_total_facebook_likes = st.number_input('cast_crew_total_facebook_likes:',min_value=10.0, max_value=100000.0)
facenumber_in_poster = st.number_input('facenumber_in_poster:',min_value=0.0, max_value=50.0)
critic_review_ratio = st.number_input('critic_review_ratio:',min_value=1.0, max_value=100.0)
...
if st.button("PREDICT IMDb SCORE"):
    ...
    #st.success(f'The IMDb Score of the movie is {output[0]:.1f}')
